...
<!DOCTYPE html><html><head><style>%s
  </style><title>CPBX.Calldetails</title>
...
def cdr_results_html(query_result):
...
cdr_paginate_html(page, offset, rowcount)
